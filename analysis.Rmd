...
# Add working directory, substitute * in quotes (leave "/" for folders output of images and latex, or tweak). In case of bug with names of pictures as "image/vllblc.jpg":
# delete "image/".
