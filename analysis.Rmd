...
dislib <- read.csv("df_dislib.csv", sep = ",")             # sensitivity to distribution of liberals, sensitivity analysis, ethnic asymmetry
...
# sa_asym <- read.csv("df_sa_asym.csv",sep =",")  #  PREVIOUS version is saved on GITHUB !! CHECK IF WORTH IT

# Checked for 90!
sa_asym <- read.csv("sa_asym_90.csv",sep =",")      
etlib <- read.csv("etlib_90.csv",sep =",")


# dfloc <- read.csv("test_90/etlib_loc.csv",sep = ",", skip = 6)
# dfmin <- read.csv("test_90/etlib_min.csv",sep = ",", skip = 6)
# names(dfloc) <- pull(read.csv("test_90/legend_90.csv"))
# names(dfmin) <- pull(read.csv("test_90/legend_90.csv"))
# etlib <- select(etlib, - c(32:47))
# IDloc <- "etlib_loc"
# IDmn <- "etlib_min"
# dfloc <- cbind(IDloc,dfloc)
# dfmin <- cbind(IDmn,dfmin)
# names(dfmin)[names(dfmin) == "IDmn"] <- "ID"
# etlib <- rbind(etlib,dfmin)
# write.csv(etlib,"etlib_90.csv",row.names=FALSE)
 


# for labels

circle_orange.labs <- c("20% liberal minority", "50% liberal minority", "80% liberal minority","10% liberal minority","90% liberal minority")
names(circle_orange.labs) <- c("20","50","80","10","90")
...
# database filter
sa_asym <- sa_asym %>% filter(circle_orange == 10 | circle_orange == 50 | circle_orange == 90)
excl <- names(sa_asym) %in% c("run", "ID","density","step","eth_lib_loc","val_con_loc","eth_lib_min","val_con_min")
dataset_sa <- sa_asym[!excl] %>% filter(eth_con_loc  == 20,eth_con_min   == 20,val_lib_min == 20)  %>% 
group_by(val_lib_loc ,fraction_blue,circle_blue, circle_orange) %>% summarise_all(c("mean"= mean,"sd"= sd)) 

plotname <- "vllblc.jpg"  # delete images/ if bug
xlab_t <- "ß value liberal local"
...
plotname <- "vllbmn.jpg"  # delete images/ if bug
xlab_t <- "ß value liberal minority"
...
# database filter
etlib <- etlib %>% filter(circle_orange == 10 | circle_orange == 50 | circle_orange == 90)
...
plotname <- "et_libloc.jpg" # delete images/ if bug
...
plotname <- "et_libmin.jpg" # delete images/ if bug
...
print(tablerb_prox50,type = "latex", file = "vllblc50.tex"  , include.rownames=FALSE, add.to.row = addtorow, include.colnames = FALSE, latex.environments = "center")


df_vllblc10 <- dataset_sa %>%  filter(circle_orange == 10)
tablerb_prox10 <- xtable(df_vllblc10[,c("val_lib_loc","de_sq_bl_mean","de_sq_bl_sd","de_cl_bl_mean","de_cl_bl_sd","de_sq_or_mean","de_sq_or_sd","de_cl_or_mean","de_cl_or_sd","dv_sq_bl_mean","dv_sq_bl_sd","dv_cl_bl_mean","dv_cl_bl_sd","dv_sq_or_mean","dv_sq_or_sd","dv_cl_or_mean","dv_cl_or_sd")], digits = 3)
align(tablerb_prox10) <- "c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|"
addtorow <- list()
addtorow$pos <- list(0, 0,0,0,0)
addtorow$command <- c("\\multicolumn{17}{|c|}{Ethnic Asymmetry, $10 \\%$ Liberal Migrants: Spatial Proximity}  \\\\\\hline\n",
   "Preference &  \\multicolumn{8}{|c|}{Ethnic Proximity} & \\multicolumn{8}{|c|}{Value Proximity}   \\\\\\hline\n",
  "& \\multicolumn{4}{|c|}{Local} & \\multicolumn{4}{|c|}{Minority}  & \\multicolumn{4}{|c|}{Local} & \\multicolumn{4}{|c|}{Minority}  \\\\\n",
"$\\beta$ value & \\multicolumn{2}{|c|}{Conservative} & \\multicolumn{2}{|c|}{Liberal} 
& \\multicolumn{2}{|c|}{Conservative} & \\multicolumn{2}{|c|}{Liberal} & \\multicolumn{2}{|c|}{Conservative} & \\multicolumn{2}{|c|}{Liberal} 
& \\multicolumn{2}{|c|}{Conservative} & \\multicolumn{2}{|c|}{Liberal}\\\\\n",
"liberal local & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD\\\\\n")
print(tablerb_prox10,type = "latex", file = "vllblc10.tex" , include.rownames=FALSE, add.to.row = addtorow, include.colnames = FALSE, latex.environments = "center")

df_vllblc90 <- dataset_sa %>%  filter(circle_orange == 90)
tablerb_prox90 <- xtable(df_vllblc90[,c("val_lib_loc","de_sq_bl_mean","de_sq_bl_sd","de_cl_bl_mean","de_cl_bl_sd","de_sq_or_mean","de_sq_or_sd","de_cl_or_mean","de_cl_or_sd","dv_sq_bl_mean","dv_sq_bl_sd","dv_cl_bl_mean","dv_cl_bl_sd","dv_sq_or_mean","dv_sq_or_sd","dv_cl_or_mean","dv_cl_or_sd")], digits = 3)
align(tablerb_prox90) <- "c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|"
addtorow <- list()
addtorow$pos <- list(0, 0,0,0,0)
addtorow$command <- c("\\multicolumn{17}{|c|}{Ethnic Asymmetry, $90 \\%$ Liberal Migrants: Spatial Proximity}  \\\\\\hline\n",
   "Preference &  \\multicolumn{8}{|c|}{Ethnic Proximity} & \\multicolumn{8}{|c|}{Value Proximity}   \\\\\\hline\n",
  "& \\multicolumn{4}{|c|}{Local} & \\multicolumn{4}{|c|}{Minority}  & \\multicolumn{4}{|c|}{Local} & \\multicolumn{4}{|c|}{Minority}  \\\\\n",
"$\\beta$ value & \\multicolumn{2}{|c|}{Conservative} & \\multicolumn{2}{|c|}{Liberal} 
& \\multicolumn{2}{|c|}{Conservative} & \\multicolumn{2}{|c|}{Liberal} & \\multicolumn{2}{|c|}{Conservative} & \\multicolumn{2}{|c|}{Liberal} 
& \\multicolumn{2}{|c|}{Conservative} & \\multicolumn{2}{|c|}{Liberal}\\\\\n",
"liberal local & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD\\\\\n")
print(tablerb_prox90,type = "latex", file = "vllblc90.tex" , include.rownames=FALSE, add.to.row = addtorow, include.colnames = FALSE, latex.environments = "center")
...
print(tablerb_mn50,type = "latex", file = "vllbmn50.tex"  , include.rownames=FALSE, add.to.row = addtorow, include.colnames = FALSE, latex.environments = "center")


df_vllbmn10 <- dataset_sa %>%  filter(circle_orange == 10)
tablerb_mn10 <- xtable(df_vllbmn10[,c("val_lib_min","de_sq_bl_mean","de_sq_bl_sd","de_cl_bl_mean","de_cl_bl_sd","de_sq_or_mean","de_sq_or_sd","de_cl_or_mean","de_cl_or_sd","dv_sq_bl_mean","dv_sq_bl_sd","dv_cl_bl_mean","dv_cl_bl_sd","dv_sq_or_mean","dv_sq_or_sd","dv_cl_or_mean","dv_cl_or_sd")], digits = 3)
...
& \\multicolumn{2}{|c|}{Conservative} & \\multicolumn{2}{|c|}{Liberal}\\\\\n",
"liberal minority & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD\\\\\n")
print(tablerb_mn10,type = "latex", file = "vllbmn10.tex" , include.rownames=FALSE, add.to.row = addtorow, include.colnames = FALSE, latex.environments = "center")

df_vllbmn90 <- dataset_sa %>%  filter(circle_orange == 90)
tablerb_mn90 <- xtable(df_vllbmn90[,c("val_lib_min","de_sq_bl_mean","de_sq_bl_sd","de_cl_bl_mean","de_cl_bl_sd","de_sq_or_mean","de_sq_or_sd","de_cl_or_mean","de_cl_or_sd","dv_sq_bl_mean","dv_sq_bl_sd","dv_cl_bl_mean","dv_cl_bl_sd","dv_sq_or_mean","dv_sq_or_sd","dv_cl_or_mean","dv_cl_or_sd")], digits = 3)
align(tablerb_mn90) <- "c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|"
addtorow <- list()
addtorow$pos <- list(0, 0,0,0,0)
addtorow$command <- c("\\multicolumn{17}{|c|}{Ethnic Asymmetry, $90 \\%$ Liberal Migrants: Spatial Proximity}  \\\\\\hline\n",
   "Preference &  \\multicolumn{8}{|c|}{Ethnic Proximity} & \\multicolumn{8}{|c|}{Value Proximity}   \\\\\\hline\n",
...
& \\multicolumn{2}{|c|}{Conservative} & \\multicolumn{2}{|c|}{Liberal}\\\\\n",
"liberal minority & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD\\\\\n")
print(tablerb_mn90,type = "latex", file = "vllbmn90.tex" , include.rownames=FALSE, add.to.row = addtorow, include.colnames = FALSE, latex.environments = "center")
...
& \\multicolumn{2}{|c|}{Conservative} & \\multicolumn{2}{|c|}{Liberal}\\\\\n",
"liberal local & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD\\\\\n")
print(etlib_loc50,type = "latex", file = "etlib_loc50.tex"  , include.rownames=FALSE, add.to.row = addtorow, include.colnames = FALSE, latex.environments = "center")


df_etlib_loc10 <- etlib_df %>%  filter(circle_orange == 10)
etlib_loc10 <- xtable(df_etlib_loc10[,c("eth_lib_loc","de_sq_bl_mean","de_sq_bl_sd","de_cl_bl_mean","de_cl_bl_sd","de_sq_or_mean","de_sq_or_sd","de_cl_or_mean","de_cl_or_sd","dv_sq_bl_mean","dv_sq_bl_sd","dv_cl_bl_mean","dv_cl_bl_sd","dv_sq_or_mean","dv_sq_or_sd","dv_cl_or_mean","dv_cl_or_sd")], digits = 3)
align(etlib_loc10) <- "c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|"
addtorow <- list()
addtorow$pos <- list(0, 0,0,0,0)
addtorow$command <- c("\\multicolumn{17}{|c|}{Ethnic Asymmetry, $10 \\%$ Liberal Migrants: Spatial Proximity}  \\\\\\hline\n",
   "Preference &  \\multicolumn{8}{|c|}{Ethnic Proximity} & \\multicolumn{8}{|c|}{Value Proximity}   \\\\\\hline\n",
...
& \\multicolumn{2}{|c|}{Conservative} & \\multicolumn{2}{|c|}{Liberal}\\\\\n",
"liberal local & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD\\\\\n")
print(etlib_loc10,type = "latex", file = "etlib_loc10.tex" , include.rownames=FALSE, add.to.row = addtorow, include.colnames = FALSE, latex.environments = "center")

df_etlib_loc90 <- etlib_df %>%  filter(circle_orange == 90)
etlib_loc90 <- xtable(df_etlib_loc90[,c("eth_lib_loc","de_sq_bl_mean","de_sq_bl_sd","de_cl_bl_mean","de_cl_bl_sd","de_sq_or_mean","de_sq_or_sd","de_cl_or_mean","de_cl_or_sd","dv_sq_bl_mean","dv_sq_bl_sd","dv_cl_bl_mean","dv_cl_bl_sd","dv_sq_or_mean","dv_sq_or_sd","dv_cl_or_mean","dv_cl_or_sd")], digits = 3)
align(etlib_loc90) <- "c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|"
addtorow <- list()
addtorow$pos <- list(0, 0,0,0,0)
addtorow$command <- c("\\multicolumn{17}{|c|}{Ethnic Asymmetry, $90 \\%$ Liberal Migrants: Spatial Proximity}  \\\\\\hline\n",
   "Preference &  \\multicolumn{8}{|c|}{Ethnic Proximity} & \\multicolumn{8}{|c|}{Value Proximity}   \\\\\\hline\n",
...
& \\multicolumn{2}{|c|}{Conservative} & \\multicolumn{2}{|c|}{Liberal}\\\\\n",
"liberal local & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD\\\\\n")
print(etlib_loc90,type = "latex", file = "etlib_loc90.tex" , include.rownames=FALSE, add.to.row = addtorow, include.colnames = FALSE, latex.environments = "center")
...
& \\multicolumn{2}{|c|}{Conservative} & \\multicolumn{2}{|c|}{Liberal}\\\\\n",
"liberal minority & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD\\\\\n")
print(etlib_min50,type = "latex", file = "etlib_min50.tex"  , include.rownames=FALSE, add.to.row = addtorow, include.colnames = FALSE, latex.environments = "center")


df_etlib_min10 <- etlib_df %>%  filter(circle_orange == 10)
etlib_min10 <- xtable(df_etlib_min10[,c("eth_lib_min","de_sq_bl_mean","de_sq_bl_sd","de_cl_bl_mean","de_cl_bl_sd","de_sq_or_mean","de_sq_or_sd","de_cl_or_mean","de_cl_or_sd","dv_sq_bl_mean","dv_sq_bl_sd","dv_cl_bl_mean","dv_cl_bl_sd","dv_sq_or_mean","dv_sq_or_sd","dv_cl_or_mean","dv_cl_or_sd")], digits = 3)
align(etlib_min10) <- "c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|"
addtorow <- list()
addtorow$pos <- list(0, 0,0,0,0)
addtorow$command <- c("\\multicolumn{17}{|c|}{Ethnic Asymmetry, $10 \\%$ Liberal Migrants: Spatial Proximity}  \\\\\\hline\n",
   "Preference &  \\multicolumn{8}{|c|}{Ethnic Proximity} & \\multicolumn{8}{|c|}{Value Proximity}   \\\\\\hline\n",
...
& \\multicolumn{2}{|c|}{Conservative} & \\multicolumn{2}{|c|}{Liberal}\\\\\n",
"liberal minority & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD\\\\\n")
print(etlib_min10,type = "latex", file = "etlib_min10.tex" , include.rownames=FALSE, add.to.row = addtorow, include.colnames = FALSE, latex.environments = "center")

df_etlib_min90 <- etlib_df %>%  filter(circle_orange == 90)
etlib_min90 <- xtable(df_etlib_min90[,c("eth_lib_min","de_sq_bl_mean","de_sq_bl_sd","de_cl_bl_mean","de_cl_bl_sd","de_sq_or_mean","de_sq_or_sd","de_cl_or_mean","de_cl_or_sd","dv_sq_bl_mean","dv_sq_bl_sd","dv_cl_bl_mean","dv_cl_bl_sd","dv_sq_or_mean","dv_sq_or_sd","dv_cl_or_mean","dv_cl_or_sd")], digits = 3)
align(etlib_min90) <- "c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|"
addtorow <- list()
addtorow$pos <- list(0, 0,0,0,0)
addtorow$command <- c("\\multicolumn{17}{|c|}{Ethnic Asymmetry, $90 \\%$ Liberal Migrants: Spatial Proximity}  \\\\\\hline\n",
   "Preference &  \\multicolumn{8}{|c|}{Ethnic Proximity} & \\multicolumn{8}{|c|}{Value Proximity}   \\\\\\hline\n",
...
& \\multicolumn{2}{|c|}{Conservative} & \\multicolumn{2}{|c|}{Liberal}\\\\\n",
"liberal minority & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD\\\\\n")
print(etlib_min90,type = "latex", file = "etlib_min90.tex" , include.rownames=FALSE, add.to.row = addtorow, include.colnames = FALSE, latex.environments = "center")
