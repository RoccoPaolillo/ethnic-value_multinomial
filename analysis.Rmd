...
ggplot(data = data_f, aes(x = dominant, y = Segra, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) +
 scale_x_discrete(limits=c(seq(0,20 ,by = 1))) + scale_y_continuous(limits=c(0,1), breaks=seq(0,1,by=0.10)) +
  scale_linetype_manual(values=c("solid","dotted"), labels = c("ethnic","value"), guide = guide_legend(title = "Dimension", order = 1)) +
...
print(table_rb,type = "latex", file = "basic_rb.tex", include.rownames=FALSE, add.to.row = addtorow, include.colnames = FALSE, latex.environments = "center")
...
print(table_rb,type = "latex", file = "basic_rb_sec0.tex", include.rownames=FALSE, add.to.row = addtorow, include.colnames = FALSE, latex.environments = "center")

```

```{r base_lib, fig.width=30, fig.cap="Test mechanism: increase value liberal, all other 0", echo=FALSE}
...
data_f <- dom_lib %>% gather(key= subgroup, value = Segra, et_sq_bl_mean, vl_sq_bl_mean, et_cl_bl_mean, vl_cl_bl_mean, et_sq_or_mean, vl_sq_or_mean, et_cl_or_mean, vl_cl_or_mean) %>% mutate(
 ...
 dom_libpic <- ggplot(data = data_f, aes(x = dominant_circle, y = Segra, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) +
 scale_x_discrete(limits=c(seq(0,20 ,by = 1))) + scale_y_continuous(limits=c(0,1), breaks=seq(0,1,by=0.10)) +
  scale_linetype_manual(values=c("solid","dotted"), labels = c("ethnic","value"), guide = guide_legend(title = "Dimension", order = 1)) +
  scale_color_manual(values = c("blue","darkorange"), guide = guide_legend(title="Ethnicity", order = 2)) + 
  scale_shape_manual(values = c("square","circle"), guide = guide_legend(title="Orientation" ,override.aes = list(size = 3), order = 3)) +
...
table_rb <- xtable(dom_lib[,c("dominant_circle","et_sq_bl_mean","et_sq_bl_sd","et_cl_bl_mean","et_cl_bl_sd","et_sq_or_mean","et_sq_or_sd","et_cl_or_mean","et_cl_or_sd","vl_sq_bl_mean","vl_sq_bl_sd","vl_cl_bl_mean","vl_cl_bl_sd","vl_sq_or_mean","vl_sq_or_sd","vl_cl_or_mean","vl_cl_or_sd")], digits = 3)
align(table_rb) <- "c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|"

addtorow <- list()
addtorow$pos <- list(0, 0,0,0,0)
addtorow$command <-  c("\\multicolumn{17}{|c|}{Baseline: sensitivity to value liberal}  \\\\\\hline\n",
   "Preference &  \\multicolumn{8}{|c|}{Ethnic Exposure} & \\multicolumn{8}{|c|}{Value Exposure}   \\\\\\hline\n",
  "& \\multicolumn{4}{|c|}{Local} & \\multicolumn{4}{|c|}{Minority}  & \\multicolumn{4}{|c|}{Local} & \\multicolumn{4}{|c|}{Minority}  \\\\\n",
# note
"$\\beta$ dom liberal & \\multicolumn{2}{|c|}{Conservative} & \\multicolumn{2}{|c|}{Liberal} 
& \\multicolumn{2}{|c|}{Conservative} & \\multicolumn{2}{|c|}{Liberal} & \\multicolumn{2}{|c|}{Conservative} & \\multicolumn{2}{|c|}{Liberal} 
& \\multicolumn{2}{|c|}{Conservative} & \\multicolumn{2}{|c|}{Liberal}\\\\\n",
" & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD\\\\\n")


print(table_rb,type = "latex", file = "dom_lib_rb.tex", include.rownames=FALSE, add.to.row = addtorow, include.colnames = FALSE, latex.environments = "center")

```

```{r base_con, fig.width=30, fig.cap="Test mechanism: increase ethnic conservative, all other 0", echo=FALSE}

# database filter
excl <- names(value_basic) %in% c("run","density","step")
dom_con <- value_basic[!excl] %>% filter(ID == "dom_sqr") %>%
   group_by(ID,dominant_square, secondary_square,dominant_circle,secondary_circle,fraction_blue,circle_blue,circle_orange) %>%
  #secondary_square == 0 & dominant_circle == 0 & secondary_circle == 0) %>% group_by(dominant_square) 
...
dom_conpic <- ggplot(data = data_f, aes(x = dominant_square, y = Segra, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) +
 scale_x_discrete(limits=c(seq(0,20 ,by = 1))) + scale_y_continuous(limits=c(0,1), breaks=seq(0,1,by=0.10)) +
  scale_linetype_manual(values=c("solid","dotted"), labels = c("ethnic","value"), guide = guide_legend(title = "Dimension", order = 1)) +
  scale_color_manual(values = c("blue","darkorange"), guide = guide_legend(title="Ethnicity", order = 2)) + 
  scale_shape_manual(values = c("square","circle"), guide = guide_legend(title="Orientation" ,override.aes = list(size = 3), order = 3)) +
...
table_rb <- xtable(dom_con[,c("dominant_square","et_sq_bl_mean","et_sq_bl_sd","et_cl_bl_mean","et_cl_bl_sd","et_sq_or_mean","et_sq_or_sd","et_cl_or_mean","et_cl_or_sd","vl_sq_bl_mean","vl_sq_bl_sd","vl_cl_bl_mean","vl_cl_bl_sd","vl_sq_or_mean","vl_sq_or_sd","vl_cl_or_mean","vl_cl_or_sd")], digits = 3)
align(table_rb) <- "c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|"

addtorow <- list()
addtorow$pos <- list(0, 0,0,0,0)
addtorow$command <-  c("\\multicolumn{17}{|c|}{Baseline: sensitivity to ethnic conservative}  \\\\\\hline\n",
   "Preference &  \\multicolumn{8}{|c|}{Ethnic Exposure} & \\multicolumn{8}{|c|}{Value Exposure}   \\\\\\hline\n",
  "& \\multicolumn{4}{|c|}{Local} & \\multicolumn{4}{|c|}{Minority}  & \\multicolumn{4}{|c|}{Local} & \\multicolumn{4}{|c|}{Minority}  \\\\\n",
# note
...
print(table_rb,type = "latex", file = "dom_con_rb.tex", include.rownames=FALSE, add.to.row = addtorow, include.colnames = FALSE, latex.environments = "center")

```

```{r comb_value, fig.cap="Combined picture, value sensitivity", echo=FALSE}
...
plotname <- "images/comb_index.jpg"
...
fig_exp <- ggplot(data = data_exp, aes(x = dominant, y = Expo, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) +
 scale_x_discrete(limits=c(seq(0,20 ,by = 1))) + scale_y_continuous(limits=c(0,1), breaks=seq(0,1,by=0.10)) +
...
fig_prox <- ggplot(data = data_prox, aes(x = dominant, y = Prox, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) +
...
& \\multicolumn{2}{|c|}{Conservative} & \\multicolumn{2}{|c|}{Liberal} & \\multicolumn{2}{|c|}{Conservative} & \\multicolumn{2}{|c|}{Liberal} 
& \\multicolumn{2}{|c|}{Conservative} & \\multicolumn{2}{|c|}{Liberal}\\\\\n",
"$\\beta$ sec = 0  & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD & Mean & SD\\\\\n")
...
fig_exp <- ggplot(data = data_exp, aes(x = circle_orange, y = Expo, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) +
...
fig_prox <- ggplot(data = data_prox, aes(x = circle_orange, y = Prox, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) +
 scale_x_discrete(limits=c(seq(10,90 ,by = 10))) + scale_y_continuous(limits=c(min(data_prox$Prox),max(data_prox$Prox)), breaks=seq(0,max(data_prox$Prox),by=0.50)) +
    geom_vline(xintercept = 50, color = "red") +
  scale_linetype_manual(values=c("solid","dotted"), labels = c("ethnic","value"), guide = guide_legend(title = "Segregation", order = 1)) +
  scale_color_manual(values = c("blue","darkorange"), guide = guide_legend(title="Ethnicity", order = 2)) + 
  scale_shape_manual(values = c("square","circle"), guide = guide_legend(title="Value" ,override.aes = list(size = 3), order = 3)) +
...
prox_eth_con_loc <- ggplot(data = data_prox, aes(x = eth_con_loc, y = Prox, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) + 
 scale_x_discrete(limits=c(seq(0,20 ,by = 1))) + scale_y_continuous(limits=c(min(data_prox$Prox),max(data_prox$Prox)), breaks=seq(0,max(data_prox$Prox),by=0.50)) +
...
# ggsave("images/eth_con_loc50.jpg",plot = fig_prox,
#   device = NULL,path = NULL, 
#   scale = 1,
#   width = 8,
#   height = 6,
...
prox_val_lib_loc <- ggplot(data = data_prox, aes(x = val_lib_loc, y = Prox, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) +
 scale_x_discrete(limits=c(seq(0,20 ,by = 1))) + scale_y_continuous(limits=c(min(data_prox$Prox),max(data_prox$Prox)), breaks=seq(0,max(data_prox$Prox),by=0.50)) +
#☻    facet_wrap(~ circle_orange, labeller = labeller(circle_orange = circle_orange.labs)) +
      geom_vline(xintercept = 20, color = "red") +
  scale_linetype_manual(values=c("solid","dotted"), labels = c("ethnic","value"), guide = guide_legend(title = "Segregation", order = 1)) +
...
prox_eth_con_min <- ggplot(data = data_prox, aes(x = eth_con_min, y = Prox, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) +
 scale_x_discrete(limits=c(seq(0,20 ,by = 1))) + scale_y_continuous(limits=c(min(data_prox$Prox),max(data_prox$Prox)), breaks=seq(0,max(data_prox$Prox),by=0.50)) +
#☻    facet_wrap(~ circle_orange, labeller = labeller(circle_orange = circle_orange.labs)) +
      geom_vline(xintercept = 20, color = "red") +
  scale_linetype_manual(values=c("solid","dotted"), labels = c("ethnic","value"), guide = guide_legend(title = "Segregation", order = 1)) +
...
prox_val_lib_min <- ggplot(data = data_prox, aes(x = val_lib_min, y = Prox, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) +
 scale_x_discrete(limits=c(seq(0,20 ,by = 1))) + scale_y_continuous(limits=c(min(data_prox$Prox),max(data_prox$Prox)), breaks=seq(0,max(data_prox$Prox),by=0.50)) +
#☻    facet_wrap(~ circle_orange, labeller = labeller(circle_orange = circle_orange.labs)) +
      geom_vline(xintercept = 20, color = "red") +
...
exp_eth_con_loc <- ggplot(data = data_exp, aes(x = eth_con_loc, y = Expo, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) +
 scale_x_discrete(limits=c(seq(0,20 ,by = 1))) + scale_y_continuous(limits=c(0,1), breaks=seq(0,1,by=0.10)) +
 #    facet_wrap(~ circle_orange, labeller = labeller(circle_orange = circle_orange.labs)) +
    geom_vline(xintercept = 20, color = "red") +
  scale_linetype_manual(values=c("solid","dotted"), labels = c("ethnic","value"), guide = guide_legend(title = "Segregation", order = 1)) +
...
exp_val_lib_loc <- ggplot(data = data_exp, aes(x = val_lib_loc, y = Expo, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) +
 scale_x_discrete(limits=c(seq(0,20 ,by = 1)))  + scale_y_continuous(limits=c(0,1), breaks=seq(0,1,by=0.10)) +
 #    facet_wrap(~ circle_orange, labeller = labeller(circle_orange = circle_orange.labs)) +
    geom_vline(xintercept = 20, color = "red") +
  scale_linetype_manual(values=c("solid","dotted"), labels = c("ethnic","value"), guide = guide_legend(title = "Segregation", order = 1)) +
...
exp_eth_con_min <-  ggplot(data = data_exp, aes(x = eth_con_min, y = Expo, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) +
 scale_x_discrete(limits=c(seq(0,20 ,by = 1)))  + scale_y_continuous(limits=c(0,1), breaks=seq(0,1,by=0.10)) +
 #    facet_wrap(~ circle_orange, labeller = labeller(circle_orange = circle_orange.labs)) +
    geom_vline(xintercept = 20, color = "red") +
  scale_linetype_manual(values=c("solid","dotted"), labels = c("ethnic","value"), guide = guide_legend(title = "Segregation", order = 1)) +
...
# ggsave("images/eth_con_min50.jpg",plot = fig_expo,
#   device = NULL,path = NULL, 
#   scale = 1,
#   width = 8,
#   height = 6,
...
exp_val_lib_min <- ggplot(data = data_exp, aes(x = val_lib_min, y = Expo, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) +
 scale_x_discrete(limits=c(seq(0,20 ,by = 1)))  + scale_y_continuous(limits=c(0,1), breaks=seq(0,1,by=0.10)) +
  #    facet_wrap(~ circle_orange, labeller = labeller(circle_orange = circle_orange.labs)) +
    geom_vline(xintercept = 20, color = "red") +
  scale_linetype_manual(values=c("solid","dotted"), labels = c("ethnic","value"), guide = guide_legend(title = "Segregation", order = 1)) +
...
plot_50 <- ggplot(data = subset(data_prox, circle_orange == 50), aes(x = eth_con_loc, y = Prox, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) + 
 scale_x_discrete(limits=c(seq(0,20 ,by = 1))) + scale_y_continuous(limits=c(min(data_prox$Prox),max(data_prox$Prox)), breaks=seq(0,max(data_prox$Prox),by=0.50)) +
# facet_wrap(~ circle_orange, ncol = 2, nrow = 2, labeller = labeller(circle_orange = circle_orange.labs)) +
    geom_vline(xintercept = 20, color = "red") +
  ...
  scale_shape_manual(values = c("square","circle"), guide = guide_legend(title="Value" ,override.aes = list(size = 3), order = 3)) +
  xlab(xlab_t) + ylab("Spatial Proximity") + 
  theme_bw() +  theme( axis.title.x = (element_text(size = 13)), axis.title.y = (element_text(size = 15)), axis.text.x =  (element_text(size = 12)),axis.text.y =  (element_text(size = 15)), legend.title = element_text(size = 13),legend.position = "bottom", legend.text = element_text(size = 13),plot.title=element_text(hjust = 0.5), plot.caption = element_text(hjust= 0.5, size = 11)) + theme(plot.margin=unit(c(0.1,0.1,0.1,0.1),"cm")) +
 labs( caption = paste0(subset(data_prox, circle_orange == 50)$circle_orange,"% liberal migrants"))

plot_20 <- ggplot(data = subset(data_prox, circle_orange == 20), aes(x = eth_con_loc, y = Prox, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) + 
 scale_x_discrete(limits=c(seq(0,20 ,by = 1))) + scale_y_continuous(limits=c(min(data_prox$Prox),max(data_prox$Prox)), breaks=seq(0,max(data_prox$Prox),by=0.50)) +
# facet_wrap(~ circle_orange, ncol = 2, nrow = 2, labeller = labeller(circle_orange = circle_orange.labs)) +
    geom_vline(xintercept = 20, color = "red") +
    geom_hline(yintercept = 1, color = "red") +
  ...
  xlab(xlab_t) + ylab("Spatial Proximity") + 
  theme_bw() +  theme( axis.title.x = (element_text(size = 13)), axis.title.y = (element_text(size = 15)), axis.text.x =  (element_text(size = 12)),axis.text.y =  (element_text(size = 15)), legend.title = element_text(size = 13),legend.position = "bottom", legend.text = element_text(size = 13),plot.title=element_text(hjust = 0.5), plot.caption = element_text(hjust= 0.5, size = 11)) + theme(plot.margin=unit(c(0.1,0.1,0.1,0.1),"cm")) +
 labs( caption = paste0(subset(data_prox, circle_orange == 20)$circle_orange,"% liberal migrants"))

plot_80 <- ggplot(data = subset(data_prox, circle_orange == 80), aes(x = eth_con_loc, y = Prox, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) + 
 scale_x_discrete(limits=c(seq(0,20 ,by = 1))) + scale_y_continuous(limits=c(min(data_prox$Prox),max(data_prox$Prox)), breaks=seq(0,max(data_prox$Prox),by=0.50)) +
# facet_wrap(~ circle_orange, ncol = 2, nrow = 2, labeller = labeller(circle_orange = circle_orange.labs)) +
    geom_vline(xintercept = 20, color = "red") +
    geom_hline(yintercept = 1, color = "red") +
  ...
  xlab(xlab_t) + ylab("Spatial Proximity") + 
  theme_bw() +  theme( axis.title.x = (element_text(size = 13)), axis.title.y = (element_text(size = 15)), axis.text.x =  (element_text(size = 12)),axis.text.y =  (element_text(size = 15)), legend.title = element_text(size = 13),legend.position = "bottom", legend.text = element_text(size = 13),plot.title=element_text(hjust = 0.5), plot.caption = element_text(hjust= 0.5, size = 11)) + theme(plot.margin=unit(c(0.1,0.1,0.1,0.1),"cm")) +
 labs( caption = paste0(subset(data_prox, circle_orange == 80)$circle_orange,"% liberal migrants"))

ggpubr::ggarrange(plot_50,plot_80,plot_20,expo_pic, nrow = 2, ncol = 2, common.legend = TRUE, legend = "bottom")
...
plot_50 <- ggplot(data = subset(data_prox, circle_orange == 50), aes(x = val_lib_loc, y = Prox, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) + 
 scale_x_discrete(limits=c(seq(0,20 ,by = 1))) + scale_y_continuous(limits=c(min(data_prox$Prox),max(data_prox$Prox)), breaks=seq(0,max(data_prox$Prox),by=0.50)) +
# facet_wrap(~ circle_orange, ncol = 2, nrow = 2, labeller = labeller(circle_orange = circle_orange.labs)) +
...
plot_20 <- ggplot(data = subset(data_prox, circle_orange == 20), aes(x = val_lib_loc, y = Prox, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) + 
 scale_x_discrete(limits=c(seq(0,20 ,by = 1))) + scale_y_continuous(limits=c(min(data_prox$Prox),max(data_prox$Prox)), breaks=seq(0,max(data_prox$Prox),by=0.50)) +
# facet_wrap(~ circle_orange, ncol = 2, nrow = 2, labeller = labeller(circle_orange = circle_orange.labs)) +
    geom_vline(xintercept = 20, color = "red") +  geom_hline(yintercept = 1, color = "red") +
  scale_linetype_manual(values=c("solid","dashed"), labels = c("ethnic","value"), guide = guide_legend(title = "Segregation", order = 1)) +
...
plot_80 <- ggplot(data = subset(data_prox, circle_orange == 80), aes(x = val_lib_loc, y = Prox, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) + 
 scale_x_discrete(limits=c(seq(0,20 ,by = 1))) + scale_y_continuous(limits=c(min(data_prox$Prox),max(data_prox$Prox)), breaks=seq(0,max(data_prox$Prox),by=0.50)) +
# facet_wrap(~ circle_orange, ncol = 2, nrow = 2, labeller = labeller(circle_orange = circle_orange.labs)) +
    geom_vline(xintercept = 20, color = "red") +  geom_hline(yintercept = 1, color = "red") +
  scale_linetype_manual(values=c("solid","dashed"), labels = c("ethnic","value"), guide = guide_legend(title = "Segregation", order = 1)) +
...
plot_50 <- ggplot(data = subset(data_prox, circle_orange == 50), aes(x = eth_con_min, y = Prox, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) + 
 scale_x_discrete(limits=c(seq(0,20 ,by = 1))) + scale_y_continuous(limits=c(min(data_prox$Prox),max(data_prox$Prox)), breaks=seq(0,max(data_prox$Prox),by=0.50)) +
# facet_wrap(~ circle_orange, ncol = 2, nrow = 2, labeller = labeller(circle_orange = circle_orange.labs)) +
    geom_vline(xintercept = 20, color = "red") +  geom_hline(yintercept = 1, color = "red") +
  scale_linetype_manual(values=c("solid","dashed"), labels = c("ethnic","value"), guide = guide_legend(title = "Segregation", order = 1)) +
...
plot_20 <- ggplot(data = subset(data_prox, circle_orange == 20), aes(x = eth_con_min, y = Prox, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) + 
 scale_x_discrete(limits=c(seq(0,20 ,by = 1))) + scale_y_continuous(limits=c(min(data_prox$Prox),max(data_prox$Prox)), breaks=seq(0,max(data_prox$Prox),by=0.50)) +
# facet_wrap(~ circle_orange, ncol = 2, nrow = 2, labeller = labeller(circle_orange = circle_orange.labs)) +
    geom_vline(xintercept = 20, color = "red") +  geom_hline(yintercept = 1, color = "red") +
  scale_linetype_manual(values=c("solid","dashed"), labels = c("ethnic","value"), guide = guide_legend(title = "Segregation", order = 1)) +
...
plot_80 <- ggplot(data = subset(data_prox, circle_orange == 80), aes(x = eth_con_min, y = Prox, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) + 
 scale_x_discrete(limits=c(seq(0,20 ,by = 1))) + scale_y_continuous(limits=c(min(data_prox$Prox),max(data_prox$Prox)), breaks=seq(0,max(data_prox$Prox),by=0.50)) +
# facet_wrap(~ circle_orange, ncol = 2, nrow = 2, labeller = labeller(circle_orange = circle_orange.labs)) +
    geom_vline(xintercept = 20, color = "red") +  geom_hline(yintercept = 1, color = "red") +
  scale_linetype_manual(values=c("solid","dashed"), labels = c("ethnic","value"), guide = guide_legend(title = "Segregation", order = 1)) +
...
plot_50 <- ggplot(data = subset(data_prox, circle_orange == 50), aes(x = val_lib_min, y = Prox, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) + 
 scale_x_discrete(limits=c(seq(0,20 ,by = 1))) + scale_y_continuous(limits=c(min(data_prox$Prox),max(data_prox$Prox)), breaks=seq(0,max(data_prox$Prox),by=0.50)) +
# facet_wrap(~ circle_orange, ncol = 2, nrow = 2, labeller = labeller(circle_orange = circle_orange.labs)) +
    geom_vline(xintercept = 20, color = "red") +  geom_hline(yintercept = 1, color = "red") +
  scale_linetype_manual(values=c("solid","dashed"), labels = c("ethnic","value"), guide = guide_legend(title = "Segregation", order = 1)) +
...
plot_20 <- ggplot(data = subset(data_prox, circle_orange == 20), aes(x = val_lib_min, y = Prox, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) + 
 scale_x_discrete(limits=c(seq(0,20 ,by = 1))) + scale_y_continuous(limits=c(min(data_prox$Prox),max(data_prox$Prox)), breaks=seq(0,max(data_prox$Prox),by=0.50)) +
# facet_wrap(~ circle_orange, ncol = 2, nrow = 2, labeller = labeller(circle_orange = circle_orange.labs)) +
    geom_vline(xintercept = 20, color = "red") +  geom_hline(yintercept = 1, color = "red") +
  scale_linetype_manual(values=c("solid","dashed"), labels = c("ethnic","value"), guide = guide_legend(title = "Segregation", order = 1)) +
...
plot_80 <- ggplot(data = subset(data_prox, circle_orange == 80), aes(x = val_lib_min, y = Prox, linetype = `segregation` , color = `ethnia`, shape = `orientation`)) + geom_line()  +  geom_point(size = 3) + 
 scale_x_discrete(limits=c(seq(0,20 ,by = 1))) + scale_y_continuous(limits=c(min(data_prox$Prox),max(data_prox$Prox)), breaks=seq(0,max(data_prox$Prox),by=0.50)) +
# facet_wrap(~ circle_orange, ncol = 2, nrow = 2, labeller = labeller(circle_orange = circle_orange.labs)) +
    geom_vline(xintercept = 20, color = "red") +  geom_hline(yintercept = 1, color = "red") +
  scale_linetype_manual(values=c("solid","dashed"), labels = c("ethnic","value"), guide = guide_legend(title = "Segregation", order = 1)) +
...
```{r sa_vllbmnTEST,  fig.cap="Sensitivity proximity value liberal minority, distribution liberals", echo=FALSE}
...
plot_50 <- ggplot(data = data_prox, aes(x = val_lib_min, y = Prox, linetype = `segregation` , fill = `ethnia`,  shape = `orientation`)) + geom_line(aes(color = `ethnia`))  +  geom_point(color = "black", size = 4) + 
 scale_x_discrete(limits=c(seq(0,20 ,by = 1))) + scale_y_continuous(limits=c(min(data_prox$Prox),max(data_prox$Prox)), breaks=seq(0,max(data_prox$Prox),by=0.50)) +
...
ggpubr::ggarrange(plot_50, expo_pic, common.legend = TRUE, legend = "bottom")
