...
A <- subplot(lowE,lowV) %>% layout(annotations = list(
 list(x = 0.2 , y = 1 , text = "Ethnic", showarrow = F, xref='paper', yref='paper'),
  list(x = 0.8 , y = 1, text = "Value", showarrow = F, xref='paper', yref='paper'))
)
