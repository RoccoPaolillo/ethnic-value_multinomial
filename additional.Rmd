...
#  df3 <- read.csv("3Detlibhigh.csv",sep = ",",skip = 6)
# df4 <- read.csv("3Detliblow.csv",sep = ",",skip = 6)
# 
# leg <- read.csv("legend_sa_asym.csv",sep=";")[,1]
# df_fin <- rbind(df,df2,df3,df4)
#  names(df_fin)<- leg
# # 
#   write.csv(df_fin,"3D.csv",row.names = F)
#  
#  
...
df_3D_low <- cbind(df_3D[,1:11],df_3D[,vars]) %>% filter(val_lib_loc==5,val_lib_min==5,eth_con_loc == 5,eth_con_min == 5,eth_lib_loc ==0,eth_lib_min==0)
df_3D_high <- cbind(df_3D[,1:11],df_3D[,vars]) %>% filter(val_lib_loc==20,val_lib_min==20,eth_con_loc == 20,eth_con_min == 20,eth_lib_loc ==0,eth_lib_min==0)

lowE <- plot_ly(df_3D_low)  %>%
  add_trace(x=df_3D_low$fraction_blue,y=df_3D_low$circle_orange,z=df_3D_low$de_sq_bl,
            scene = "scene1",
                                       # name = "Ethnic",
                                       type="scatter3d",
                                       mode="markers",
                                     ...
                                     #    c(0.75,'blue'),
                                     #    c(1, 'purple')),
                                       color= df_3D_low$et_sq_bl, showscale =  T,
 ...
 lowV<- plot_ly(df_3D_low)  %>%   add_trace(x=df_3D_low$fraction_blue,y=df_3D_low$circle_orange,z=df_3D_low$dv_sq_bl,
                                          scene =  "scene2",
                                   #  name = "Value",
                                     type="scatter3d",
                                     mode="markers", 
                                    ...
                                    color= df_3D_low$vl_sq_bl , showscale = T, reversescale=T,
 ...
 highE <- plot_ly(df_3D_high)  %>%
  add_trace(x=df_3D_high$fraction_blue,y=df_3D_high$circle_orange,z=df_3D_high$de_sq_bl,
            scene = "scene3",
                                       # name = "Ethnic",
                                       type="scatter3d",
                                       mode="markers",
                                     ...
                                     #    c(0.75,'blue'),
                                     #    c(1, 'purple')),
                                       color= df_3D_high$et_sq_bl, showscale =  T,
 ...
 highV<- plot_ly(df_3D_high)  %>%   add_trace(x=df_3D_high$fraction_blue,y=df_3D_high$circle_orange,z=df_3D_high$dv_sq_bl,
                                          scene =  "scene4",
                                   #  name = "Value",
                                     type="scatter3d",
                                     mode="markers", 
                                    ...
                                    color= df_3D_high$vl_sq_bl , showscale = T, reversescale=T,
...
A <- subplot(lowE, lowV,  highE, highV) %>% 
