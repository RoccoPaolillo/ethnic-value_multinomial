...
* Figures
    + Circle orange and square orange is taken as prototype (in the legend circle, square), since any subgroup in Fig: \ref{fig:thheory} has same probability $0.25$ to relocate close to agents of same ethnicity and same value. Proof in ANNEX B, reporting behavior of circle blue and square blue
...
```{r betatwoethnic,fig.pos='H',fig.out="94%",fig.show = "hold",fig.align='center',fig.cap="Difference segregation, x-axis: difference ethnic and value square preference, faceting: circle preference", echo=FALSE, include=TRUE }
...
```{r betatwovalue,  fig.pos="H",fig.out="94%",fig.show = "hold", fig.align='center',fig.show="hold", fig.cap="Difference segregation, x-axis: difference ethnic and value circle preference, faceting: square preference", echo=FALSE, include=TRUE  }
...
v_square.labs <- c("Square ß value 0", "Square ß value 5", "Square ß value 10")
...
```{r betatwoethnicblue,fig.pos='H',fig.out="94%",fig.show = "hold",fig.align='center',fig.cap="Testing blue: Difference segregation, x-axis: difference ethnic and value square preference, faceting: circle preference", echo=FALSE, include=TRUE }
...
ibe_10 <- circle_frame %>%  filter(beta_ie_square == 10) %>% gather(key = subgroup, value = Segra, eth_sq_bl,val_sq_bl,eth_cl_bl,val_cl_bl) %>% mutate(`segregation` = fct_relevel(fct_collapse(subgroup,"ethnic segregation" = c("eth_sq_bl","eth_cl_bl"), "value segregation" = c("val_sq_bl","val_cl_bl")), "ethnic segregation"), `group` = fct_relevel(fct_collapse(subgroup, "square" = c("eth_sq_bl","val_sq_bl"), "circle" = c("eth_cl_bl","val_cl_bl"), "square"))) %>%
  ggplot(aes(x = (beta_ie_square - beta_iv_square), y = Segra, color = `segregation`, shape = `group`)) + geom_line() + geom_point( size = 2) + facet_grid(rev_beta_iv_circle ~  beta_ie_circle, labeller = labeller(rev_beta_iv_circle = rev_beta_iv_circle.labs,  beta_ie_circle = e_circle.labs )) +
  geom_vline(xintercept = 5, color = "red") +
  scale_x_discrete(name = "ß ethnic square 10 - ß value square", limits = seq(0,10, by = 1)) +  ylab("Segregation") +
  scale_color_manual(values = c("dark violet","dark green"), guide = guide_legend(title="")) +
...
ibe_5 <- circle_frame %>%  filter(beta_ie_square == 5) %>% gather(key = subgroup, value = Segra, eth_sq_bl,val_sq_bl,eth_cl_bl,val_cl_bl) %>% mutate(`segregation` = fct_relevel(fct_collapse(subgroup,"ethnic segregation" = c("eth_sq_bl","eth_cl_bl"), "value segregation" = c("val_sq_bl","val_cl_bl")), "ethnic segregation"), `group` = fct_relevel(fct_collapse(subgroup, "square" = c("eth_sq_bl","val_sq_bl"), "circle" = c("eth_cl_bl","val_cl_bl"), "square"))) %>%
  ggplot(aes(x = (beta_ie_square - beta_iv_square), y = Segra, color = `segregation`, shape = `group`)) + geom_line() + geom_point( size = 2) + facet_grid(rev_beta_iv_circle ~  beta_ie_circle, labeller = labeller(rev_beta_iv_circle = rev_beta_iv_circle.labs,  beta_ie_circle = e_circle.labs )) +
  scale_x_discrete(name = "ß ethnic square 10 - ß value square", limits = seq(0,5, by = 1)) +  ylab("Segregation") +
  scale_color_manual(values = c("dark violet","dark green"), guide = guide_legend(title="")) +
  scale_shape_manual(values = c(16,15), guide = guide_legend(title="")) +
    theme_bw() +  theme(legend.position = "bottom", legend.title = element_blank(), panel.grid.minor.x = element_blank(), plot.title=element_text(hjust = 0.5),  legend.margin=margin(0,0,0,0))
...
```{r betatwovalueblue,  fig.pos="H",fig.out="94%",fig.show = "hold", fig.align='center',fig.show="hold", fig.cap="Testing blue: Difference segregation, x-axis: difference ethnic and value circle preference, faceting: square preference", echo=FALSE, include=TRUE  }
...
ibv_10 <- circle_frame %>%  filter(beta_iv_circle == 10) %>% gather(key = subgroup, value = Segra, eth_sq_bl,val_sq_bl,eth_cl_bl,val_cl_bl) %>% mutate(`segregation` = fct_relevel(fct_collapse(subgroup,"ethnic segregation" = c("eth_sq_bl","eth_cl_bl"), "value segregation" = c("val_sq_bl","val_cl_bl")), "ethnic segregation"), `group` = fct_relevel(fct_collapse(subgroup, "square" = c("eth_sq_bl","val_sq_bl"), "circle" = c("eth_cl_bl","val_cl_bl"), "square")))  %>%
  ggplot(aes(x = (beta_iv_circle - beta_ie_circle), y = Segra, color = `segregation`, shape = `group`)) + geom_line() + geom_point( size = 2) + facet_grid(rev_beta_ie_square ~  beta_iv_square, labeller = labeller(rev_beta_ie_square = rev_beta_ie_square.labs, beta_iv_square = v_square.labs))  +
  geom_vline(xintercept = 5, color = "red") +
  scale_x_discrete(name = "ß value circle 10 - ß ethnic circle", limits = seq(0,10, by = 1)) +  ylab("Segregation") +
  scale_color_manual(values = c("dark violet","dark green"), guide = guide_legend(title="")) +
...
ibv_5 <- circle_frame %>%  filter(beta_iv_circle == 5) %>% gather(key = subgroup, value = Segra, eth_sq_bl,val_sq_bl,eth_cl_bl,val_cl_bl) %>% mutate(`segregation` = fct_relevel(fct_collapse(subgroup,"ethnic segregation" = c("eth_sq_bl","eth_cl_bl"), "value segregation" = c("val_sq_bl","val_cl_bl")), "ethnic segregation"), `group` = fct_relevel(fct_collapse(subgroup, "square" = c("eth_sq_bl","val_sq_bl"), "circle" = c("eth_cl_bl","val_cl_bl"), "square")))  %>%
  ggplot(aes(x = (beta_iv_circle - beta_ie_circle), y = Segra, color = `segregation`, shape = `group`)) + geom_line() + geom_point( size = 2) + facet_grid(rev_beta_ie_square ~  beta_iv_square, labeller = labeller(rev_beta_ie_square = rev_beta_ie_square.labs, beta_iv_square = v_square.labs))  +
  scale_x_discrete(name = "ß value circle 5 - ß ethnic circle", limits = seq(0,5, by = 1)) +  ylab("Segregation") +
  scale_color_manual(values = c("dark violet","dark green"), guide = guide_legend(title="")) +
  scale_shape_manual(values = c(16,15), guide = guide_legend(title="")) +
