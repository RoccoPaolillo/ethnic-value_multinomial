...
```{r testaa,  fig.width=12,fig.height=12,fig.cap="Probability to choose alternative location",fig.align="center", include=TRUE, echo=FALSE}
...
```{r test3D,  fig.width=18,fig.height=18,fig.cap="Probability to choose alternative location 3D",fig.align="center", include=TRUE, echo=FALSE}
  ...
  tit <- paste0("Ethnic weight = ",b$e_w*k,"; ","Value weight = ",b$v_w*k, "\n\r -1:MIN Alternative, 1:MAX Alternative")
   ...
   test_trida <- plot_ly(x=fx,y=fy,z=fz, type="scatter3d", color=fz, mode="markers")  %>% 
    layout(
     ...
     ), annotations = (list(x = 0.5, y = 0.8, text = tit ,
...
# 
grid.arrange(de,fe,te,ne,se,ze,ncol=2,nrow=3)
