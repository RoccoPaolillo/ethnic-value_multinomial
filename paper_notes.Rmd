...
f_val <- function(e_w,ew_ng,i_v,S_v,Mv){
  if (round(abs(e_w-ew_ng), digits=2) <= i_v) {
    U <- 1
      ...
      U <- (Mv + ((1-(round(abs(e_w-ew_ng), digits=2)))*(1-Mv))/(1-i_v)) * S_v
        # (M + ((1-(round(abs(e_w-ew_ng), digits=2)))*(1-M))/(1-i_v)) * S
      }
  round(U,digits = 3)
  }
...
fvf0p  <- f_val(e_w,0,i_v,S_v,Mv)
fvf1p  <- f_val(e_w,0.1,i_v,S_v,Mv)
fvf2p   <- f_val(e_w,0.2,i_v,S_v,Mv)
fvf3p   <- f_val(e_w,0.3,i_v,S_v,Mv)
fvf4p   <- f_val(e_w,0.4,i_v,S_v,Mv)
fvf5p   <- f_val(e_w,0.5,i_v,S_v,Mv)
fvf6p   <- f_val(e_w,0.6,i_v,S_v,Mv)
fvf7p   <- f_val(e_w,0.7,i_v,S_v,Mv)
fvf8p   <- f_val(e_w,0.8,i_v,S_v,Mv)
fvf9p  <- f_val(e_w,0.9,i_v,S_v,Mv)
fvf10p  <- f_val(e_w,1.0,i_v,S_v,Mv)
...
fvf0t <- f_val(e_w,0,i_v,S_v,Mv)
fvf1t  <- f_val(e_w,0.1,i_v,S_v,Mv)
fvf2t   <- f_val(e_w,0.2,i_v,S_v,Mv)
fvf3t   <- f_val(e_w,0.3,i_v,S_v,Mv)
fvf4t   <- f_val(e_w,0.4,i_v,S_v,Mv)
fvf5t   <- f_val(e_w,0.5,i_v,S_v,Mv)
fvf6t  <- f_val(e_w,0.6,i_v,S_v,Mv)
fvf7t   <- f_val(e_w,0.7,i_v,S_v,Mv)
fvf8t   <- f_val(e_w,0.8,i_v,S_v,Mv)
fvf9t  <- f_val(e_w,0.9,i_v,S_v,Mv)
fvf10t  <- f_val(e_w,1.0,i_v,S_v,Mv)
...
i_e = 0.3   # parameters to manipulate
...
i_v <- 0.0    # Symmetric = S:1,M:0/Threshold = S:0
S_v  <- 1
Mv <- 0

fv0d2 <- f_val(e_w,0,i_v,S_v,Mv)             # value utility for each option, 
fv1d2 <- f_val(e_w,0.1,i_v,S_v,Mv)           # increasing nuMber is average ethnic weight of neighborhood j
fv2d2 <- f_val(e_w,0.2,i_v,S_v,Mv)
fv3d2 <- f_val(e_w,0.3,i_v,S_v,Mv)
fv4d2 <- f_val(e_w,0.4,i_v,S_v,Mv)
fv5d2 <- f_val(e_w,0.5,i_v,S_v,Mv)
fv6d2 <- f_val(e_w,0.6,i_v,S_v,Mv)
fv7d2 <- f_val(e_w,0.7,i_v,S_v,Mv)
fv8d2 <- f_val(e_w,0.8,i_v,S_v,Mv)
fv9d2 <- f_val(e_w,0.9,i_v,S_v,Mv)
fv10d2 <- f_val(e_w,1.0,i_v,S_v,Mv)
...
report_V <- na.omit(data.frame(Mv,S_v,des_dist,ew_agent,mean_ew_ng,Utility_V))
