...
name <- paste0("Ethnic weight i = ", e_w,"; desired distance i = ",i_v,"; M = ",M,"; S = ",S)
...
report_v <- paste0(name,"; Mean ethnic weight j = ", seq(0.0, 1.0, by = 0.1), "; Utility ij = ", Utility_V)
...
# prob <- function(e_w,s,t,v_w,p,q){1 / (1 + exp(-e_w*(d_u_e)) + exp(-v_w*(d_u_v)))}
