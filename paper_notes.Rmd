...
A <- data.frame(x_graph,utility_location,funct_symm)
...
A_graph <- ggplot(A,aes(x_graph,utility_location)) 
...
M_0 <- c(NA,NA,NA,NA,1,0.76,0.5,0.24,0)  # should be 0.75 and 0.24, I think due to round(U)2 in the function
