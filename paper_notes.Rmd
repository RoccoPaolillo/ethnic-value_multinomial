...
- Seemingly, @zhang2004 describes $\epsilon$ as other characteristics of the option which affects the actual choice of that option (i.e. neighborhood). Esser's [@esser2010] definition of costs of the choice can be taken into consideration, as costs of moving to the neighborhood.
...
- The formula $\beta u (.) + \epsilon$\ should become somthing like $\N_{e} U_{e} + \N_{v} U_{v} + \N_{s} U_{s} - C$ where $\N: need$, $\C: cost$ and $e,v,s$ the ethnic, value and socio-economic status dimension.

# Limits

- Both $\u$ and $\beta$ can vary across individuals, but the model would explode in its complexity
- Even if we consider households as agents who make a choice, the decision to relocate/where to live can be the product of negotiation of people in that household. Too complicated to be included
