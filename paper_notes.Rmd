...
M + ((1 - \frac{x}{n}) \times (1 - M)) / (1 - i_e), & \text{if} \ x > n\times i_e 
\end{cases}
$$
...
symm_val_plot <- symm_val_graph + geom_point() + theme_bw() + labs(x = "Mean ethnic weight neighborhood j",y = "utility for location") + ggtitle(label = "Symmetric Single Peaked \n\r (S=1,M=0) ",subtitle = "desired distance = 0.2") + theme(plot.title = element_text(hjust = 0.5), plot.subtitle = element_text(hjust = 0.5))  + scale_x_continuous(breaks = seq(0.0,1.0,by = 0.1))

thres_val_plot <- thres_val_graph + geom_point() + theme_bw() + labs(x = "Mean ethnic weight neighborhood j",y = "utility for location") + ggtitle(label = "Threshold Schelling \n\r (S=0,M=1) ",subtitle = "desired distance = 0.2") + theme(plot.title = element_text(hjust = 0.5), plot.subtitle = element_text(hjust = 0.5))  + scale_x_continuous(breaks = seq(0.0,1.0,by = 0.1))
