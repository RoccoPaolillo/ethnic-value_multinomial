...
```{r value graph function, fig.width=5,fig.height= 6, fig.align="center", include=TRUE, echo=FALSE}
...
```{r ethnic utility individual-run,fig.align="center", fig.pos="H", include=TRUE, echo=FALSE}
...
report_E <- data.frame(M.,S.,prop_des,num_tot,num_sim,Utility_E)
