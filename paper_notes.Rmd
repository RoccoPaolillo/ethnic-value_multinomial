...
\
- Given the existence of an ideal payoff to make a choice $u$, why should someone give more importance to that dimension over the other, that is, why should $\beta$ vary among individuals? An answer in Esser
