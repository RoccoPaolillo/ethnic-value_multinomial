...
to move-turtles          ; choice for each turtle. The agent makes a patch-set combined of current location and an empty patch (the options)
  ...
  ask one-of turtles [
    ...
    let beta-ie ifelse-value (shape = "square") [e_sqr ] [e_crl ]
    let beta-iv ifelse-value (shape = "square") [v_sqr ] [v_crl ]

    ; let beta-ie ifelse-value (shape = "local") [ifelse-value (shape = "square") [e_blue_sqr][e_blue_crl]] [ifelse-value (shape = "square")[e_orng_sqr][e_orng_crl]]
...
<experiments>
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="true">
    ...
    <timeLimit steps="80"/>
    <metric>ticks</metric>
    <metric>mean [count (turtles-on neighbors)]  of turtles  with [ethnicity = "local"   and shape = "circle"   and count (turtles-on neighbors) &gt;= 1]</metric>
    <metric>mean [count (turtles-on neighbors) with [ethnicity = [ethnicity] of myself]] of turtles with [ethnicity = "local"  and shape = "circle"   and count (turtles-on neighbors) &gt;= 1]</metric>
    <metric>mean  [count (turtles-on neighbors) with [shape = [shape] of myself]] of turtles with [ethnicity = "local"   and shape = "circle"  and count (turtles-on neighbors) &gt;= 1]</metric>
    <metric>mean [count (turtles-on neighbors)]  of turtles  with [ethnicity = "local"   and shape =  "square"   and count (turtles-on neighbors) &gt;= 1]</metric>
    <metric>mean [count (turtles-on neighbors) with [ethnicity = [ethnicity] of myself]] of turtles with [ethnicity = "local"  and shape =   "square"   and count (turtles-on neighbors) &gt;= 1]</metric>
    <metric>mean  [count (turtles-on neighbors) with [shape = [shape] of myself]] of turtles with [ethnicity = "local"   and shape =   "square"  and count (turtles-on neighbors) &gt;= 1]</metric>
    <metric>mean [count (turtles-on neighbors)]  of turtles  with [ethnicity =   "minority"    and shape = "circle"   and count (turtles-on neighbors) &gt;= 1]</metric>
    <metric>mean [count (turtles-on neighbors) with [ethnicity = [ethnicity] of myself]] of turtles with [ethnicity =   "minority"   and shape = "circle"   and count (turtles-on neighbors) &gt;= 1]</metric>
    <metric>mean  [count (turtles-on neighbors) with [shape = [shape] of myself]] of turtles with [ethnicity =   "minority"   and shape = "circle"  and count (turtles-on neighbors) &gt;= 1]</metric>
    <metric>mean [count (turtles-on neighbors)]  of turtles  with [ethnicity = "minority"   and shape =  "square"   and count (turtles-on neighbors) &gt;= 1]</metric>
    <metric>mean [count (turtles-on neighbors) with [ethnicity = [ethnicity] of myself]] of turtles with [ethnicity = "minority"  and shape =   "square"   and count (turtles-on neighbors) &gt;= 1]</metric>
    <metric>mean  [count (turtles-on neighbors) with [shape = [shape] of myself]] of turtles with [ethnicity = "minority"   and shape =   "square"  and count (turtles-on neighbors) &gt;= 1]</metric>
    ...
    <enumeratedValueSet variable="e_sqr">
      <value value="30"/>
    </enumeratedValueSet>
    <steppedValueSet variable="v_sqr" first="0" step="1" last="30"/>
    <enumeratedValueSet variable="v_crl">
      <value value="30"/>
    </enumeratedValueSet>
    <steppedValueSet variable="e_crl" first="0" step="1" last="30"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
