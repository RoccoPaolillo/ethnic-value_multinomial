...
to move-turtles          ; here the relocation decision, I might simplify further
  ...
  ask turtles [
    ...
    let beta-ie ifelse-value (color = blue) [ifelse-value (shape = "square") [eth_loc_con][eth_loc_lib]] [ifelse-value (shape = "square")[eth_min_con][eth_min_lib]]
    let beta-iv ifelse-value (color = blue) [ifelse-value (shape = "square") [val_loc_con][val_loc_lib]] [ifelse-value (shape = "square")[val_min_con][val_min_lib]]
...
510
eth-sqr-bl
mean [\n(count (turtles-on neighbors) with [color = [color] of myself] / count (turtles-on neighbors))\n / \n(count turtles with [color = [color] of myself] / count turtles)\n] \nof turtles with [color = blue and shape = \"square\" and count (turtles-on neighbors) >= 1]
2
1
11
...
510
eth-sqr-or
mean [\n(count (turtles-on neighbors) with [color = [color] of myself] / count (turtles-on neighbors))\n / \n(count turtles with [color = [color] of myself] / count turtles)\n] \nof turtles with [color = orange and shape = \"square\" and count (turtles-on neighbors) >= 1]
2
1
11
...
557
eth-crl-bl
mean [\n(count (turtles-on neighbors) with [color = [color] of myself] / count (turtles-on neighbors))\n/ \n(count turtles with [color = [color] of myself] / count turtles)\n] of turtles with [color = blue and shape = \"circle\" and count (turtles-on neighbors) >= 1]
2
1
11
...
557
eth-crl-or
mean [\n(count (turtles-on neighbors) with [color = [color] of myself] / count turtles-on neighbors)\n / \n(count turtles with [color = [color] of myself] / count turtles)\n] \nof turtles with [color = orange and shape = \"circle\" and count (turtles-on neighbors) >= 1]
2
1
11
...
512
val-sqr-bl
mean [\n(count (turtles-on neighbors) with [shape = [shape] of myself] / count (turtles-on neighbors))\n/ \n(count turtles with [shape = [shape] of myself] / count turtles)\n] of turtles with [color = blue and shape = \"square\" and count (turtles-on neighbors) >= 1]
2
1
11
...
"" ""
PENS
"sqr-blu" 1.0 0 -13345367 true "" "if exposure_correct [plot mean [\n(count (turtles-on neighbors) with [color = [color] of myself] / count turtles-on neighbors) \n/ \n(count turtles with [color = [color] of myself] / count turtles)\n] \nof turtles with [color = blue and shape = \"square\" and count (turtles-on neighbors) >= 1]\n]"
"crl-blu" 1.0 0 -13791810 true "" "if exposure_correct [plot mean [\n(count (turtles-on neighbors) with [color = [color] of myself] / count turtles-on neighbors)\n / \n (count turtles with [color = [color] of myself] / count turtles)\n ]\n of turtles with [color = blue and shape = \"circle\" and count (turtles-on neighbors) >= 1]\n ]"
"sqr-org" 1.0 0 -955883 true "" "if exposure_correct [plot mean [\n(count (turtles-on neighbors) with [color = [color] of myself] / count turtles-on neighbors) \n/ \n(count turtles with [color = [color] of myself] / count turtles)\n] \nof turtles with [color = orange and shape = \"square\" and count (turtles-on neighbors) >= 1]\n]"
"crl-org" 1.0 0 -6995700 true "" "if exposure_correct [plot mean [\n(count (turtles-on neighbors) with [color = [color] of myself] / count turtles-on neighbors) \n/ \n(count turtles with [color = [color] of myself] / count turtles)\n] \nof turtles with [color = orange and shape = \"circle\" and count (turtles-on neighbors) >= 1]\n]"
...
1401
461
measure exposure correct (exposure neighborhood /fraction population)
11
0.0
1
...
Example of full parameters version of model. It includes the exposure correct (fraction others similar in neighborhood / fraction similar in population). Notes:
- Calculate and plot exposure correct (fraction of fraction) is computational demanding. Recommended swithc "exposure correct" off to not plot the index.
- Substituted  "ethnicity" in the code with color of agents (tag). So they not store another variable. Nothing changes, corrected in outputs, "ethnicity" should not appear.
- Deleted "density" and "diff" utility output monitors, not used.
...
The probability to relocate to alternative is implemented with the roulette wheel selection through logistic function
