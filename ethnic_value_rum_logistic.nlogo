...
to-report utility [a b c]  ; utility function: a = number similar (neighborhood moore); b = number total ; c = threshold

report ( ifelse-value (b = 0) [0]     ; utility 0 for not any turtle on neighbor
   [ ifelse-value (a = (b * c)) [1]     ; max utility 1 for number similar = fraction desired (b*c)
    [ifelse-value (a < (b * c))
     [precision (a / (b * c)) 3                 ; utility if number similar is less than desired fraction (b * c) = linearly increasing
       ][ precision (c + (((1 - (a / b)) * (1 - c)) / (1 - c))) 3]   ; utility if number similar is more than desired fraction (b * c) = linearly decreasing slope by desired threshold c
      ]
    ]
   )
...
<experiments>
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="e_blue_crl">
      <value value="3"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="v_orng_sqr">
      <value value="3"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="v_blue_sqr">
      <value value="3"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="e_orng_crl">
      <value value="3"/>
    </enumeratedValueSet>
