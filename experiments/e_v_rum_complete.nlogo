...
to move-turtles          ; here the relocation decision, I might simplify further
  ...
  ask  turtles [
    ...
    let beta-ie ifelse-value (color = blue) [ifelse-value (shape = "square") [eth_con_loc][eth_lib_loc]] [ifelse-value (shape = "square")[eth_con_min][eth_lib_min]]
    let beta-iv ifelse-value (color = blue) [ifelse-value (shape = "square") [val_con_loc][val_lib_loc]] [ifelse-value (shape = "square")[val_con_min][val_lib_min]]
...
<experiments>
  <experiment name="etcnlc" repetitions="20" runMetricsEveryStep="false">
    ...
    <steppedValueSet variable="eth_con_loc" first="0" step="1" last="20"/>
  ...
  <experiment name="vllblc" repetitions="20" runMetricsEveryStep="false">
    ...
    <steppedValueSet variable="val_lib_loc" first="0" step="1" last="20"/>
    <enumeratedValueSet variable="eth_con_min">
      <value value="0"/>
      <value value="20"/>
    </enumeratedValueSet>
  ...
  <experiment name="etcnmn" repetitions="20" runMetricsEveryStep="false">
    ...
    <steppedValueSet variable="eth_con_min" first="0" step="1" last="20"/>
    <enumeratedValueSet variable="val_lib_min">
      <value value="0"/>
      <value value="20"/>
    </enumeratedValueSet>
  ...
  <experiment name="vllbmn" repetitions="20" runMetricsEveryStep="false">
    ...
    <steppedValueSet variable="val_lib_min" first="0" step="1" last="20"/>
    <enumeratedValueSet variable="val_con_loc">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="eth_lib_loc">
  ...
  <experiment name="etlib_loc" repetitions="20" runMetricsEveryStep="false">
    ...
    <steppedValueSet variable="eth_lib_loc" first="0" step="1" last="20"/>
    <enumeratedValueSet variable="eth_lib_min">
      <value value="0"/>
      <value value="5"/>
      <value value="20"/>
  ...
  <experiment name="etlib_min" repetitions="20" runMetricsEveryStep="false">
    ...
    <steppedValueSet variable="eth_lib_min" first="0" step="1" last="20"/>
    <enumeratedValueSet variable="val_con_loc">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="val_con_min">
  ...
  <experiment name="dislib" repetitions="20" runMetricsEveryStep="false">
    ...
    <steppedValueSet variable="circle_orange" first="0" step="10" last="100"/>
    <enumeratedValueSet variable="eth_con_loc">
      <value value="20"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="val_lib_loc">
