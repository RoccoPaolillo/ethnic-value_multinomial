...
to move-turtles          ; here the relocation decision, I might simplify further
  ...
  ask  turtles [
    ...
    let beta-ie ifelse-value (shape = "square") [dominant_square][secondary_circle] ; for square ethnicity is the dominant preference
    let beta-iv ifelse-value (shape =  "circle") [dominant_circle][secondary_square] ; for circle value is the dominant preference
...
@#$#@#$#@
<experiments>
  <experiment name="dom_crl" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    ...
    <steppedValueSet variable="dominant_circle" first="0" step="1" last="20"/>
    <enumeratedValueSet variable="secondary_circle">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="dominant_square">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="secondary_square">
      <value value="0"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="dom_sqr" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>mean [count (turtles-on neighbors) with [color = [color] of myself] / count (turtles-on neighbors) ] of turtles with [ count (turtles-on neighbors) &gt;= 1 and shape = "square" and color = blue]</metric>
    ...
    <enumeratedValueSet variable="dominant_circle">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="secondary_circle">
      <value value="0"/>
    </enumeratedValueSet>
    <steppedValueSet variable="dominant_square" first="0" step="1" last="20"/>
    <enumeratedValueSet variable="secondary_square">
      <value value="0"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="sec_crl" repetitions="20" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>mean [count (turtles-on neighbors) with [color = [color] of myself] / count (turtles-on neighbors) ] of turtles with [ count (turtles-on neighbors) &gt;= 1 and shape = "square" and color = blue]</metric>
    ...
    <steppedValueSet variable="secondary_circle" first="0" step="1" last="20"/>
    <enumeratedValueSet variable="dominant_square">
      <value value="20"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="secondary_square">
  ...
  <experiment name="sec_sqr" repetitions="20" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>mean [count (turtles-on neighbors) with [color = [color] of myself] / count (turtles-on neighbors) ] of turtles with [ count (turtles-on neighbors) &gt;= 1 and shape = "square" and color = blue]</metric>
    ...
    <steppedValueSet variable="secondary_square" first="0" step="1" last="20"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
